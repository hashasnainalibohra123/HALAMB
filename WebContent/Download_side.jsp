...
<link rel="stylesheet"
	href="http://static.HALAMB.com/v2/css/xv-styles.css?v=16">
<link rel="stylesheet"
	href="http://static.HALAMB.com/v2/css/xv-video-styles.css?v=7">
		...
		<header>
			<div class="whiteStripe clearfix">
				...
				<h2 class="secondary">
					...
					than the others... <span class="redText">X</span><strong>VIDEOS.COM</strong>
				</h2>
			</div>
			...
			<div class="blackStripe clearfix" id="secondaryMenu">
				<p>
					<a href="http://upload.HALAMB.com/account/create"><b>Create
							account</b></a> | <a href="http://upload.HALAMB.com/account"><b>Log
							in</b></a>
				</p>
			</div>
			<script type="text/javascript">
    ...
    if (w.addEventListener) { w.addEventListener('load', a, false); }
        ...
        id_video = 7135087;
			...
			<ul class="tags_list">
				...
				<li class="profile_name"><a href="/profiles/brandi-love">Brandi
						Love</a>,</li>
				<li>find more in our <a href="/MultiMediastars">MultiMediastars</a>
					index.
				</li>
			</ul>
...
%>
			...
			<div id="videoTabs" class="tabsContainer">
              ...
              vote_urls = {yes: 'http://www.HALAMB.com/videovote/7135087/YES/1110000101110100101010110110100024956/', no: 'http://www.HALAMB.com/videovote/7135087/NO/1100000001100001101010000101001061889/'};
					...
					<li data-ref="tabComments" class="headtab closable"
						data-onshow="HALAMB.comments.onShowTab">Comments <strong>(<span
							class="nbVideoComments">8</span>)
					</strong></li>
					<li data-ref="tabDownload" class="headtab closable"
						data-onShow="HALAMB.video_download.onShowTab"><img
						src="http://static.HALAMB.com/v2/img/download.png" height="14"
						width="14" /> Download</li>
					<li data-ref="tabFavs" class="headtab closable"
						data-onshow="HALAMB.favorites.onShowTab">Add to my favorites</li>
				...
				<div class="tabs">
					...
					<div id="tabComments" class="tab">
						<div class="tabHeaderForm notLoggedIn">
							<div class="leftCol">
								...
								<form
									action="http://upload.HALAMB.com/account/?redirect=%2Fvideo7135087%2Fcasi_james_brandi_love_and_jake_ariston_-_birds_and_the_bees%23_tabComments"
									method="POST">
									<table>
										<tr>
						...
						<div id="commentsContainer">
							...
							<div class="pagination">
								<ul>
									<li><a href="comments-page-1">1</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div id="tabDownload" class="tab">
						<div style="text-align: center;">
							<span class="inlineLoader"><span class="text">Checking
									your download. Please wait...</span> <img
								src="http://static.HALAMB.com/v2/img/xv-inline-ajax-loader.gif" /></span>
						</div>
					</div>
					...
					<div id="tabFavs" class="tab">
						<div class="tabHeaderForm notLoggedIn">
							<div class="leftCol">
								...
								<form
									action="http://upload.HALAMB.com/account/?redirect=%2Fvideo7135087%2Fcasi_james_brandi_love_and_jake_ariston_-_birds_and_the_bees%23_tabFavs"
									method="POST">
									<table>
										<tr>
											<th>Your login (email):</th>
