...
org.hibernate.Query,
 ...
 java.awt.image.BufferedImage;" %>   <%ArrayList user= null,user2=null;
		boolean flag=false;
...
%>
  ...
  <div class="adminBox">
    ...
    <div class="contentbox" id="changeEmail">
          <form id="changeEmailForm" method="POST" action="update_email">
        <div class="formLine">
          <label>Change your email adress:</label>
          <div class="content">
      ...
      %>
            ...
            <p>Your email has not been validated yet. Please click <a href="/account/email/validate">Here</a> to validate it.<br>
        A validated email is requested to create your profile page and receive notifications on your profile.</p>
       <%} %> 
        </div>
