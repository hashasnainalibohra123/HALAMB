  ...
  <div id="page">
    <header>
      <div class="whiteStripe clearfix">
        ...
        <h2 class="secondary"><span class="redText">BIGGER</span> and <span class="redText">BETTER</span> than the others... <span class="redText">HALAMB.COM</strong></h2>
      </div>
...
(function(w, d) { var a = function() { var a = d.createElement('script'); a.type = 'text/javascript';
      ...
      <div id="content">
        ...
        <div id="player" ">
			...
			if(Formate.equals("video/mp4"))
			{
				...
				%>
				<A href="Download?Image_Id=<%=m.getImage_id() %>">
  ...
  <object data="movie.mp4" >
    <embed  src="movie.swf">
				...
				<%-- <video src="\<%=m.getLink() %>"  /> --%></A>
						      	<%}

			if(m.getFormate().equals("image/jpeg"))
			{
						%>
			<A href="Download?Image_Id=<%=m.getImage_id() %>"><img src="\<%=m.getLink() %>" width="450" height="500"  /></A>
							      	<%}
			}
...
%>
      ...
      <div id="videoTabs" class="tabsContainer">
        <ul class="tabButtons">
          ...
          <input type="button" id="dom" value="Comments ->" onclick="setVisibility('hasu', 'inline')" />


		  <li data-ref="tabDownload" class="headtab closable" onclick="varify(<%=Image_Id %>);"><img src="http://static.HALAMB.com/v2/img/download.png" height="14" width="14" /> Comments</li>
		  <li data-ref="tabDownload" class="headtab closable" ><img src="http://static.HALAMB.com/v2/img/download.png" height="14" width="14" /> Download</li>
        ...
        </script><li data-ref="tabShare" class="headtab closable">Share</li>
        ...
        <div class="tabs">
          ...
          <div id="tabComments" class="tab">
			...
			session.setAttribute("Image_Id",Image_Id);
				...
				{	%>
				<h3 class="blackTitle" >Comments <span class="nbVideoComments"></span>:</h3>
          ...
          <div id="tabFavs" class="tab" >
			...
			session.setAttribute("Image_Id",Image_Id);
				...
				%>
				<h3 class="blackTitle" >Add to my Favorites <span class="nbVideoComments"></span>:</h3>
				<div class="leftCol">
					<p><strong><p><strong>You must be logged in to add a favorite.</strong></p></strong></p>
					<form method="POST" id="signinForm" action="LOGIN_ACCOUNT" >
					<table>
						<tr>
						<th>Your login (email):</th>
