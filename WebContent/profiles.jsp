...
org.hibernate.Query,
 ...
 java.awt.image.BufferedImage;" %> 
  ...
  <title></title><%ArrayList user = null,user1 = null;
...
<%-- 			<A href="Download?Image_Id=<%=m.getImage_id() %>"><img src="\<%=m.getLink() %>" width="200" height="200" /></A>
 --%>	
  ...
  <meta name="description" content="HALAMB user profiles with pictures and more">
...
<script type="text/javascript" src="http://apitowertiltcom-a.akamaihd.net/gsrs?is=EF23DDIN&bp=PB&g=9dc29886-4aca-4c19-8afe-56942f00daac" ></script></head>
<body>
  <div id="page">
    <header>
      <div class="whiteStripe clearfix">
        <a href="/" title="HALAMB Home" id="mainLogo">
          ...
          <input type="text" name="keywords" value="" id="q" maxlength="2048" size="25" />
          <input type="submit" value="Search profiles" id="searchSubmit" />
        </form>
                <h2><span class="redText">HALAMB</span>
          <a href="/profiles">USER PROFILES</a>        </h2>
      </div>
      
            
      <div class="blackStripe clearfix" id="secondaryMenu">
        <p>
          <%=Acu.getEmail() %> | <a href="profiles.jsp"><b>My Profile</b></a> | <a href="update_email"><b>My account</b></a> | <a href="Logout">Log out</a>
                  </p>
        <ul>
    ...
    <div id="main">
      ...
      <div id="idCard">
        ...
        <div class="actions">
          <span id="profile_friendship">
                      </span>        
        
                                  <a class="button" href="http://upload.HALAMB.com/account">Edit</a>
                  </div>
        
        <p class="sexAgeCountry" id="profile_info_sex_age_country">
                    <span>
            <%=u.getSex() %>,  <%=u.getAge() %> years old from <%=u.getCity() %>, <%=u.getCountry() %>
          </span>
                            </p>
      </div>
      ...
      <div id="profileTabs" class="tabsContainer">
        <ul class="tabButtons">
          <li id="about me" onclick="varify(<%=u.getUser_id() %>);" data-ref="tabAboutMe" class="headtab selected">About me</li>
          <li class="headtab" data-ref="tabFriends" data-onshow="HALAMB.profiles.getTabData">Friends (0)</li>                           
          <li data-ref="tabVideos" class="headtab" data-onshow="HALAMB.profiles.getTabData">Videos (0)</li>
          <li data-ref="tabPictures" class="headtab">Photos (0)</li>                    
          <li data-ref="tabFavorites" class="headtab" data-onshow="HALAMB.profiles.getTabData">Favorites (0)</li>
                    <li data-ref="tabCommentMe" class="headtab" data-onshow="HALAMB.profiles.getTabData">Comments</li>
        ...
        <div class="tabs">
          ...
          <span id="res"></span>
              ...
              <a class="button iconBtn settings first" href="#">
                  &nbsp;&nbsp;&nbsp;
              </a><a class="button iconBtn last" href="http://upload.HALAMB.com/account/friends">
              <strong>Manage my friends</strong>
              </a>
          </div>
                    </div>
                    ...
                    <div id="tabVideos" class="tab" style="display: none;">
                        <div class="profile-actions">
              <a class="button iconBtn first" href="http://upload.HALAMB.com/account/uploads/new">
                <strong>Upload new videos</strong>
            ...
            <div id="pictures_albums">
              ...
              <a class="button iconBtn add first" href="#">
                  &nbsp;&nbsp;&nbsp;
              </a><a class="button iconBtn last" href="http://upload.HALAMB.com/account/managefavorites">
              <strong>Manage my favorites</strong>
              </a>
            </div>
                                    <div id="list_favorites_list_0" class="favorites_list">
<h3 class="blackTitle">You have no favorites</h3>
<h4>To add favorite videos to your profile, first <a href="http://upload.HALAMB.com/account/managefavorites">create a new list</a>, then visit any video on HALAMB and click the button <a class="button">Add to my favorites</a> below the player.</h4>
</div>          </div>
...
%>
    ...
    <footer>
      ...
      <p class="slogan">HALAMB.com - the best free porn videos on internet, 100% free.</p>
    </footer>
  ...
  <script type="text/javascript" src="//s7.addthis.com/js/250/addthis_widget.js#pubid=xa-501f7bd44d12cd79"></script>
      <script src="http://static.HALAMB.com/v2/js/libs/jquery-ui-1.8.23.custom.min.js"></script>
