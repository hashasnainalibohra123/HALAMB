<%@page import="com.HALAMB.User_profile_pic"%>
 ...
 <% ArrayList user = null;
   ...
   verified          
        ...
        <div class="adminBox">
          ...
          <div class="contentbox">
            <ul>
              <li><a href="/account/profilepic" class="sel">My main picture</a></li>
...
<%	 i=new IMAGE_DATA();
		 ...
		 %>
		  <img src='\HALAMB\upload_images\Default\unknown.jpg' width="242" height="242"  />
		 <%
        ...
        <div class="dl">
          ...
          <form action="Upload_Profile_pic" enctype="multipart/form-data" method="POST">
            <input type="file" name="picture" onChange="document.getElementById('profile_picture_submit').disabled = false;" />
            <input type="hidden" name="profile_picture" value="ok" />
            <input type="submit" value="Upload" disabled="disabled" id="profile_picture_submit" onClick="form.submit(); this.disabled = true;" />
            <br>
            <em>(JPG, PNG, GIF. 50MB max)</em>
          </form>
        </div>
      </div>
