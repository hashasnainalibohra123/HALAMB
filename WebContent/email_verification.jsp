...
<head>
  ...
  <link rel="shortcut icon" href="http://static.HALAMBs.com/img/favicon_HALAMBs.ico">

  <link rel="stylesheet" href="http://static.HALAMBs.com/v2/css/xv-styles.css?v=18">
 <link rel="stylesheet" href="Accounts_style.css?v=17">
   ...
   <link rel="stylesheet" href="PROFILE_STYle.CSS?v=9">
        <script src="http://static.HALAMBs.com/v2/js/libs/modernizr-2.6.2.min.js"></script>
  ...
  <div id="page">
    <header>
      <div class="whiteStripe clearfix">
        <div id="social">
          <a href="http://www.HALAMBs.com/rss/rss.xml" target="_blank"><img src="http://static.HALAMBs.com/v2/img/xv-rss.png" alt="XML RSS feed" /></a>
          <a href="http://twitter.com/HALAMBscom" target="_blank"><img src="http://static.HALAMBs.com/v2/img/xv-red-twitter.png" alt="HALAMBs on Twitter" /></a>
        </div>
        <a href="http://www.HALAMBs.com/" title="HALAMBs Home" id="mainLogo">
          <img src="http://img100.HALAMBs.com/videos/thumbs/HALAMBs.gif" alt="HALAMBs Home" id="siteLogo" />
...
%>
      ...
      <div class="blackStripe clearfix" id="secondaryMenu">
        <p>
                    <%=u.getEmail() %> | <a href="http://www.HALAMBs.com/profiles/hasnain123"><b>My profile</b></a>
          |  <a href="/account"><b>My account</b></a>
  ...
  <div class="adminBox">
    ...
    <div class="contentbox" id="changeEmail">
        ...
        <div class="formLine">
          ...
          <div class="content">
            <input name="password" id="password_text" type="password" value=""
      ...
      %>
            ...
            <p>Your email has not been validated yet. Please validate it.<br>
...
<%
    ...
    <footer>
      <div class="botLinks">
        <a href="http://info.HALAMBs.com/legal/tos/">Terms of service</a> - 
        <a href="http://info.HALAMBs.com/">Upload Your Videos</a> - 
        <a href="http://www.ant.com/video-downloader/" target="_blank">Download our videos</a> - 
        <a href="http://info.HALAMBs.com/advertising/">Advertising</a> - 
        <a href="http://info.HALAMBs.com/content/">Content removal</a> - 
        <a href="/rss/rss.xml">RSS Updates</a> - 
        <a href="/rss/del.xml">Deletes RSS</a> - 
        <a href="http://info.HALAMBs.com/">More</a>...
      </div>

      <p class="slogan">HALAMBs.com - the best free porn videos on internet, 100% free.</p>
    </footer>
