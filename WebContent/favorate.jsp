...
<head>
  ...
  <title>My account - hasnain123 - XVIDEOS.COM</title>
  <meta http-equiv="X-Frame-Options" content="deny">

  <link rel="shortcut icon" href="http://static.xvideos.com/img/favicon_xvideos.ico">

  <link rel="stylesheet" href="http://static.xvideos.com/v2/css/xv-styles.css?v=18">
 <link rel="stylesheet" href="Accounts_style.css?v=17">
   ...
   <link rel="stylesheet" href="PROFILE_STYle.CSS?v=9">
        <script src="http://static.xvideos.com/v2/js/libs/modernizr-2.6.2.min.js"></script>
  ...
  <div id="page">
    <header>
      <div class="whiteStripe clearfix">
        <div id="social">
          <a href="http://www.xvideos.com/rss/rss.xml" target="_blank"><img src="http://static.xvideos.com/v2/img/xv-rss.png" alt="XML RSS feed" /></a>
          <a href="http://twitter.com/xvideoscom" target="_blank"><img src="http://static.xvideos.com/v2/img/xv-red-twitter.png" alt="XVideos on Twitter" /></a>
        </div>
        <a href="http://www.xvideos.com/" title="XVideos Home" id="mainLogo">
          <img src="http://img100.xvideos.com/videos/thumbs/xvideos.gif" alt="XVideos Home" id="siteLogo" />
          <h1 class="hidden">XVIDEOS.COM</h1>
        </a>
        <form action="http://www.xvideos.com/" method="get" id="searchForm">
      ...
      <div class="redStripe clearfix" id="mainMenu">
        ...
        <ul>
          <li><a href="http://www.xvideos.com/new/">New Videos</a></li>
          <li><a href="http://www.xvideos.com/best/">Best Videos</a></li>
          <li><a href="http://www.xvideos.com/pornstars">Pornstars</a></li>
          <li><a href="http://www.xvideos.com/channels">Channels</a></li>
...
org.hibernate.Query,
 ...
 java.awt.image.BufferedImage;" %>   <%ArrayList user= null,user2=null,user_f=null;
		boolean flag=false;
...
%>
  ...
  <div class="adminBox">
   ...
   <div class="contentbox">
       <h5 class="blackTitle">My favorites lists (<%=user_f.size() %> lists)</h5>
                  <form id="deleteFavoritesLists" action="ManageFavrates" method="POST" onsubmit="return confirm('Are you sure you want to delete the selected lists ?');">
        <ul>
                      <%if(user_f!=null && user_f.size()>0)
{
	...
	%>       <li>
            <input type="checkbox" name="favlist[]" value="6577094" id="favlist_6577094"  />
            <label for="favlist_6577094">
              <strong><span class="name"><%=m.getFav_list_name() %></span></strong> (0 video)
              - <span class="status"><%if(m.getVisibility()==1) %>public<%if(m.getVisibility()==2) %>Only friends
              <%if(m.getVisibility()==3) %>Registered users
              <%if(m.getVisibility()==0) %>Nobody
              </span> can see it
              - <a href="http://www.xvideos.com/favorite/6577094/asd">View online</a>
            </label>
            <input type="button" class="toggleEditFavsListPanel" id="dom<%=i1 %>" value="Edit list" onclick="setVisibility<%=i1 %>('hasu<%=i1 %>', 'inline');"/>
           ...
           </script><a class="button" href="/account/favorites/6577094">Edit videos and tags</a>
            <br>
            <span class="taglist"><em>Tagged:</em>
                            <a href="/account/favorites/6577094/#favTags">Add tags to your list</a>
                          </span>
            <br>
            <span class="editFavsListPanel" id="hasu<%=i1 %>" style="display: none">
              <span>Rename</span> <input type="text" name="new_list_name_6577094" id="new_list_name_6577094_text" value="<%=m.getFav_list_name() %>" />
              <span>and change visibility to</span>
              <select name="new_list_status_6577094" id="new_list_status_6577094_select">
              ...
              <input type="button" class="editFavsList" value="Update" data-listid="6577094" />
            </span>
          </li>
 ...
 %>
        <div class="formActions">
          <input type="submit" name="deleteFavsList" value="Delete selected list(s)*" />
        </div>
        <p class="inlineNote">*All your favorites videos will be deleted. This action is irreversible.</p>
      </form>
      ...
      <form id="addFavoritesList" action="ManageFavrates" method="POST">
        <div class="formLine">
          <label for="new_favslist_name_text">
            Create a new list of favorite videos:
          </label>
          <div class="content">
            <input type="text" name="name" id="new_favslist_name_text" value="" />
            visibility:
            <select name="status" id="new_favslist_visibility_select">
              <option value="1" selected="selected">Public</option>
              <option value="2" >Only friends</option>
              <option value="3" >Registered users</option>
              <option value="0" >Nobody</option>
            </select>
            <input type="submit" name="addFavsList" value="Submit" />
          </div>
        </div>
      </form>
              </div>
...
<%
    ...
    <footer>
      <div class="botLinks">
        <a href="http://info.xvideos.com/legal/tos/">Terms of service</a> - 
        <a href="http://info.xvideos.com/">Upload Your Videos</a> - 
        <a href="http://www.ant.com/video-downloader/" target="_blank">Download our videos</a> - 
        <a href="http://info.xvideos.com/advertising/">Advertising</a> - 
        <a href="http://info.xvideos.com/content/">Content removal</a> - 
        <a href="/rss/rss.xml">RSS Updates</a> - 
        <a href="/rss/del.xml">Deletes RSS</a> - 
        <a href="http://info.xvideos.com/">More</a>...
      </div>
  ...
  <script src="http://static.xvideos.com/v2/js/script-account.js?v=23"></script>
              </body>
</html>