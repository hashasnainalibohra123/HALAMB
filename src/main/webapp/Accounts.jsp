...
<input type="image"  src="HOT\h4.jpg" name='h1' size="200" height="200"/> -->
 ...
 <%@ include file="ImportClasses.jsp" %>
 	...
 	if (u.getVarified() != 1) {
 %> <a class="redText" href="email_verification.jsp"> unverified</a> <%
 	} else {
 %> verified <%
 	}
 %></li>
 	...
 	if (flag1 == true) {
 %> <a class="redText" href="profile_pic.jsp"> unerified</a> <%
 	} else {
 %> verified <%
 	}
 %></li>
								...
								<div class="formLine">
									...
									<div class="content">
										<select name="day" id="day_select">
											...
											<option value="10"
												<%if (u.getDob1().getMonth() + 1 == 10) {%>
												selected="selected" <%}%>>October</option>
											<option value="11"
												<%if (u.getDob1().getMonth() + 1 == 11) {%>
												selected="selected" <%}%>>November</option>
											<option value="12"
												<%if (u.getDob1().getMonth() + 1 == 12) {%>
									...
									<div class="content">
										<select name="sex" id="sex_select">
											...
											<option value="Gay man"
												<%if (u.getSex().equals("Gay man")) {%> selected="selected"
												<%}%>>Gay man</option>
							...
							<fieldset id="profile-edit-privacy-settings">
								...
								<div class="formLine">
									...
									<div class="content">
										<select name="friend_request_access"
											...
											<option value="1"
												<%if (pri.getFriend_request_access() == 1) {%>
												selected="selected" <%}%>>Everybody</option>
											<option value="2"
												<%if (pri.getFriend_request_access() == 2) {%>
												selected="selected" <%}%>>Only friends of my
												friends</option>
											<option value="0"
												<%if (pri.getFriend_request_access() == 0) {%>
								...
								<div class="formLine">
									...
									<div class="content">
										<select name="friends_list_access"
											...
											<option value="1"
												<%if (pri.getFriends_list_access() == 1) {%>
												selected="selected" <%}%>>Everybody</option>
											<option value="3"
												<%if (pri.getFriends_list_access() == 3) {%>
												selected="selected" <%}%>>Only registered</option>
											<option value="2"
												<%if (pri.getFriends_list_access() == 2) {%>
												selected="selected" <%}%>>Only friends</option>
											<option value="0"
												<%if (pri.getFriends_list_access() == 0) {%>
												selected="selected" <%}%>>No one</option>
										</select>
									</div>
								</div>
								...
								<div class="formLine">
									...
									<script type="text/javascript">
										function copy() {
											var e = document
													.getElementById("profile_tag_AF");
											var _selectedValue = e.options[e.selectedIndex].value;
											document
													.getElementById("profile_tag_AF").innerHTML += document
													.getElementById("blocked_countries").value;
										}
									</script>
								...
								<div class="formLine">
									...
									<div class="content">
										<select name="seeking" id="seeking_select">
											<option value=""
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("")) {%>
												selected="selected" <%}%>></option>
											<option value="Man"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Man")) {%>
												selected="selected" <%}%>>Man</option>
											<option value="Woman"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Woman")) {%>
												selected="selected" <%}%>>Woman</option>
											<option value="Gay man"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Gay man")) {%>
												selected="selected" <%}%>>Gay man</option>
											<option value="Lesbian woman"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Lesbian woman")) {%>
												selected="selected" <%}%>>Lesbian woman</option>
											<option value="Couple"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Couple")) {%>
												selected="selected" <%}%>>Couple</option>
											<option value="Gay couple"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Gay couple")) {%>
												selected="selected" <%}%>>Gay couple</option>
											<option value="Lesbian couple"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Lesbian couple")) {%>
												selected="selected" <%}%>>Lesbian couple</option>
											<option value="Transexual"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Transexual")) {%>
												selected="selected" <%}%>>Transexual</option>
											<option value="Transvestite"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Transvestite")) {%>
												selected="selected" <%}%>>Transvestite</option>
											<option value="Transexual couple"
												<%if (ux.getSeeking() != null)
						if (ux.getSeeking().equals("Transexual couple")) {%>
												selected="selected" <%}%>>Transexual couple</option>
										</select>
									</div>
								</div>
								<div class="formLine">
									...
									<div class="content">
										<select name="relationship" id="relationship_select">
											<option value=""
												<%if (ux.getRelationship() != null)
						if (ux.getRelationship().equals("")) {%>
												selected="selected" <%}%>></option>
											<option value="Single"
												<%if (ux.getRelationship() != null)
						if (ux.getRelationship().equals("Single")) {%>
												selected="selected" <%}%>>Single</option>
											<option value="Married"
												<%if (ux.getRelationship() != null)
						if (ux.getRelationship().equals("Married")) {%>
								...
								<div class="formLine">
									...
									<div class="content">
										<select name="kids" id="kids_select">
											<option value=""
												<%if (ux.getKids() != null)
						if (ux.getKids().equals("")) {%>
												selected="selected" <%}%>></option>
											<option value="No but do not want any"
												<%if (ux.getKids() != null)
						if (ux.getKids().equals("No but do not want any")) {%>
												selected="selected" <%}%>>No but do not want any</option>
											<option value="No but want some"
												<%if (ux.getKids() != null)
						if (ux.getKids().equals("No but want some")) {%>
												selected="selected" <%}%>>No but want some</option>
											<option value="Yes and we live together"
												<%if (ux.getKids() != null)
						if (ux.getKids().equals("Yes and we live together")) {%>
												selected="selected" <%}%>>Yes and we live together</option>
											<option value="Yes and we do not live together"
												<%if (ux.getKids() != null)
						if (ux.getKids().equals("Yes and we do not live together")) {%>
								...
								<div class="formLine">
									...
									<div class="content">
										<select name="ethnicity" id="ethnicity_select">
											<option value=""
												<%if (ux.getEthnicity() != null)
						if (ux.getEthnicity().equals("")) {%>
												selected="selected" <%}%>></option>
											<option value="Asian"
												<%if (ux.getEthnicity() != null)
						if (ux.getEthnicity().equals("Asian")) {%>
												selected="selected" <%}%>>Asian</option>
											<option value="Black"
												<%if (ux.getEthnicity() != null)
						if (ux.getEthnicity().equals("Black")) {%>
												selected="selected" <%}%>>Black</option>
											<option value="Indian"
												<%if (ux.getEthnicity() != null)
						if (ux.getEthnicity().equals("Indian")) {%>
												selected="selected" <%}%>>Indian</option>
											<option value="Latino"
												<%if (ux.getEthnicity() != null)
						if (ux.getEthnicity().equals("Latino")) {%>
												selected="selected" <%}%>>Latino</option>
											<option value="Middle Eastern"
												<%if (ux.getEthnicity() != null)
						if (ux.getEthnicity().equals("Middle Eastern")) {%>
												selected="selected" <%}%>>Middle Eastern</option>
											<option value="Mixed"
												<%if (ux.getEthnicity() != null)
						if (ux.getEthnicity().equals("Mixed")) {%>
												selected="selected" <%}%>>Mixed</option>
											<option value="White"
												<%if (ux.getEthnicity() != null)
						if (ux.getEthnicity().equals("White")) {%>
								...
								<div class="formLine form_field_body_unit">
									<select name="body_unit" id="body_unit_select">
										<option value="EU"
											<%if (ux.getBody_unit() != null)
						if (ux.getBody_unit().equals("EU")) {%>
											selected="selected" <%}%>>cm and kg</option>
										<option value="US"
											<%if (ux.getBody_unit() != null)
						if (ux.getBody_unit().equals("US")) {%>
	...
	<script>
		window.jQuery
				|| document
						.write('<script src="http://static.HALAMB.com/v2/js/libs/jquery-1.7.2.min.js"><\/script>')
	</script>
