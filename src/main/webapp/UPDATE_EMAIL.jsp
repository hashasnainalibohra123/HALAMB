...
<link rel="stylesheet"
	href="http://static.xvideos.com/v2/css/xv-styles.css?v=18">
...
<body>
	<div id="page">
		...
		<div class="whiteStripe clearfix">
			<div id="social">
				<a href="http://www.xvideos.com/rss/rss.xml" target="_blank"><img
					src="http://static.xvideos.com/v2/img/xv-rss.png"
					alt="XML RSS feed" /></a> <a href="http://twitter.com/xvideoscom"
					target="_blank"><img
					src="http://static.xvideos.com/v2/img/xv-red-twitter.png"
					alt="XVideos on Twitter" /></a>
			</div>
			<a href="http://www.xvideos.com/" title="XVideos Home" id="mainLogo">
				<img src="http://img100.xvideos.com/videos/thumbs/xvideos.gif"
...
org.hibernate.Query,
 ...
 %></li>
					...
					<div class="contentbox" id="changeEmail">
							...
							<div class="formLine">
								...
								<div class="content">
									<input type="text" name="email" value="" /> <input
										type="submit" value="Update my email address" />
								</div>
							</div>
						</form>
						<%
						...
						<p>
							Your email has not been validated yet. Please click <a
								href="/account/email/validate">Here</a> to validate it.<br>
	...
	<script>
		window.jQuery
				|| document
						.write('<script src="http://static.xvideos.com/v2/js/libs/jquery-1.7.2.min.js"><\/script>')
	</script>
