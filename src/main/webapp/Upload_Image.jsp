...
<title>Upload new videos - hasnain123 - HALAMB.COM</title>
...
<link rel="stylesheet"
	href="http://static.HALAMB.com/v2/css/xv-styles.css?v=17">
<link rel="stylesheet"
	href="http://static.HALAMB.com/v2/css/xv-profile-styles.css?v=9">
<link rel="stylesheet"
	href="http://static.HALAMB.com/v2/css/xv-account-styles.css?v=17">
...
<script src="http://static.HALAMB.com/v2/js/script-upload-v2.js"></script>
<script>
    var profile_name = "hasnain123";    var page_type = "UPLOAD";
  </script>
...
<body>
	<div id="page">
		...
		<div class="blackStripe clearfix" id="secondaryMenu">
			<p>
				<a href="http://www.HALAMB.com/profiles/hasnain123"><b>My
						profile</b></a> | <a href="/account"><b>My account</b></a> | <a
					href="/account/signout"><b>Sign out</b></a>
			</p>
		</div>
		</header>
		...
		<div id="main" class="pageAccount">
			...
			<div id="userAdminLeftPanel">
				<div class="adminBox">
					...
					<div class="contentbox">
						<ul>
							<li><strong>Email:</strong> <a class="redText"
								href="/account/email/validate">unverified</a></li>
							<li><strong>Identity:</strong> <a class="redText"
								href="/account/verify_account">unverified</a></li>
				...
				<div class="adminBox">
					...
					<div class="contentbox">
						<ul>
							<li><a href="Image_show.jsp">My images uploaded</a></li>
							<li><a href="/account/uploads/new" class="sel">Upload
									new videos</a></li>
			...
			<div id="content">
				<div class="adminBox">
					<h2>My videos - Upload new videos</h2>

					<div class="contentbox" id="account_upload">

						<p class="video-stats">
							<em>July 21, 2014, 3:51:19 pm - 0 videos in the queue / 179
								videos being encoded / 1% error rate for the last 100 videos</em>
						</p>
						<p class="upload_info">If you upload illegal content your
							account will be disabled and possibly deleted completely.</p>
						<p class="upload_info">
							<strong>Pedophiles are systematically reported to the
								FBI.</strong>
						</p>
						<p class="upload_info">
							Before uploading, be sure you are in compliance with our <a
								href="http://info.HALAMB.com/legal/tos/">TOS</a> and our <a
								href="http://info.HALAMB.com/legal/repeat/">Repeat
								infringers policy</a>.
						</p>
						<p class="upload_info">
							If you encounter some problems with our upload system, please
							read the <a href="http://info.HALAMB.com/faq/">FAQ</a> or <a
								href="http://info.HALAMB.com/contact/">contact us</a>.
						</p>
						<div class="vsep"></div>
						<ul class="upload_info">
							<li>Add plenty of tags, long title and description,
								including full girl names to get more views.</li>
							<li>5 minutes minimum please.</li>
							<li>No huge colored watermarks.</li>
						...
						<div class="uploadFormLine" id="uploadTerms">
							<input type="checkbox" name="terms" id="terms"
								onClick="checkTerms()" /> <label for="terms"><strong>I
									certify that I have the right to upload and share this video,
									that the persons in it are 18 years old or older, and agree to
									the policy of the site.</strong></label>
						</div>
						...
						<div class="uploadFormLine" id="uploadFilePickers">
							<form id="upload_form_basic" enctype="multipart/form-data"
								name="upload_form_basic"
								target="target_upload_d9bd7e5c0d14ec9b5aa376d6f5acdb2e"
								action="UploadServlet" method="POST">
								<input type="hidden" name="APC_UPLOAD_PROGRESS"
									id="progress_key" value="d9bd7e5c0d14ec9b5aa376d6f5acdb2e" />
								<input type="hidden" name="message" value="" id="message_basic" />
								<input type="file" name="upload_file" size="37"
									onchange="checkTitleBacklist(this.value); checkTerms();" /> <input
									type="submit" value="Upload" id="upload_submit" />
							</form>
							<p class="uploadOr">Or</p>
							<form id="upload_form_http" name="upload_form_http"
								target="target_upload_d9bd7e5c0d14ec9b5aa376d6f5acdb2e"
								action="/account/uploads/submit_http" method="POST">
								<input type="hidden" name="HTTP_UPLOAD_PROGRESS"
									id="progress_key_http" value="d9bd7e5c0d14ec9b5aa376d6f5acdb2e" />
								<input type="hidden" name="message" value="" id="message_http" />
								Upload a video from an URL:<br> <input type="text"
									name="file_1" size="50"
									onchange="checkTitleBacklist(this.value.substr(5,this.value.length)); checkTerms();"
									onkeyup="checkTitleBacklist(this.value.substr(5,this.value.length)); checkTerms();" />
								<input type="button" value="Upload" disabled="disabled"
									id="upload_http"
									onclick="launch_upload_http('d9bd7e5c0d14ec9b5aa376d6f5acdb2e');" />
							</form>
							<div id="message_titleblacklist"></div>
						</div>
						...
						<div id="uploadMessage">
							<p>
								<label for="message_text">You can leave a message for
									reviewers :</label> <br>
								<textarea rows="5" id="message_text"
									onChange="updateMessageBox()" onKeyUp="updateMessageBox()"></textarea>
							</p>
						</div>
					</div>
				</div>
	...
	<script src="http://static.HALAMB.com/v2/js/script-account.js?v=21"></script>
</body>
</html>