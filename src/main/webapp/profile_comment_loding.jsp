...
HttpSession session12=request.getSession(false);
	...
	{
		System.out.println("profile_id is NuLL@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"+profile_id);
 ...
 %>
	...
	config1.addAnnotatedClass(PROFILE_COMMENT_TABLE.class);
	...
	//<<<<<<<<<<<<<  Count number of commnets >>>>>>>>>>
		...
		//............imgage loding..........
				//....display image...........
					...
					queryString="from PROFILE_COMMENT_TABLE where user_id ='"+u.getUser_id()+"' ORDER BY comment_date DESC";
